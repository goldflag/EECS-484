CREATE VIEW VIEW_USER_INFORMATION(USER_ID, FIRST_NAME, LAST_NAME, YEAR_OF_BIRTH, MONTH_OF_BIRTH, DAY_OF_BIRTH, GENDER, CURRENT_CITY, CURRENT_STATE, CURRENT_COUNTRY, HOMETOWN_CITY, HOMETOWN_STATE, HOMETOWN_COUNTRY, INSTITUTION_NAME, PROGRAM_YEAR, PROGRAM_CONCENTRATION, PROGRAM_DEGREE)
        AS SELECT  U.USER_ID, U.FIRST_NAME, U.LAST_NAME, U.YEAR_OF_BIRTH, U.MONTH_OF_BIRTH, U.DAY_OF_BIRTH, U.GENDER, C.CURRENT_CITY, C.CURRENT_STATE, C.CURRENT_COUNTRY, UHC.HOMETOWN_CITY, UHC.HOMETOWN_STATE, UHC.HOMETOWN_COUNTRY, P.INSTITUTION, E.PROGRAM_YEAR, P.CONCENTRATION, P.DEGREE
        FROM USERS U
